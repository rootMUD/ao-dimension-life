...
export const AO_ACHIEVEMENT = 't5n7Op0zPQsro-NZxIuGX4izLJF5-lixZvRsO4eLZoY';
...
export const TIP_IMG = "Sending the message is endimensionLifeing a problem. Is there a picture in the post? Size just up to 200 kb for now.";
